...
import { WorkoutSkeleton } from '../../components/Skeleton/Skeleton';
...
const WorkoutScreen: React.FC = () => {
  ...
  const [ws0, ws1, ws2, ws3] = useEntranceAnimation(4, { initialDelay: 60, stagger: 110 });
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.bg }}>
            ...
            {selecting ? (
              <>
                ...
                <TouchableOpacity
                  ...
                  style={{
                    backgroundColor: selectedIds.length > 0 ? 'rgba(239,68,68,0.2)' : COLORS.bgCard,
                    borderRadius: 10,
      ...
      >
        ...
        <Animated.View style={entranceStyle(ws1)}>
        ...
        {/* Tabs */}
        <Animated.View style={entranceStyle(ws2)}>
        ...
        {/* Workout list */}
        <Animated.View style={entranceStyle(ws3)}>
          {/* Select all row */}
          {selecting && (
            <View
              style={{
